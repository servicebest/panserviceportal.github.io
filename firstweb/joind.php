  ...
  <div class="maintop">
    ...
    <div class="form">
      ...
      <div class="input_field">
        ...
        <input type="number" name="price" class="input" placeholder="Rs.249" readonly>
      </div>
      <div class="input_field">
        <label>
...
<?php 
 ...
 if (isset($_POST['submit'])) {
    ...
    $queryd = " insert into dinfo(Name,Userid,Password,Email,Contactno,City,Panno,State,Pin) values('$name','$userid','$password','$email','$mobile','$city','$pan','$state','$pin')";
