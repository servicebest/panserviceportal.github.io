...
<head>
  ...
  <title>Join Super Distributor</title>
  <style>
    *{
      margin: 0;
      padding: 0;
...
<body>
  <div class="maintop">
    <div class="title">
      Super Distributor Registration Form
    </div>
    <div class="form">
      <form method="POST">
      ...
      <div class="input_field">
        ...
        <input type="number" name="price" class="input" placeholder="Rs.549" readonly />
      </div>
      <div class="input_field">
        <label>
...
<?php 
 ...
 if (isset($_POST['submit'])) {
    ...
    $querysd = " insert into sdinfo(Name,Userid,Password,Email,Contactno,City,Panno,State,Pin) values('$name','$userid','$password','$email','$mobile','$city','$pan','$state','$pin')";

    $res = mysqli_query($con,$querysd);
